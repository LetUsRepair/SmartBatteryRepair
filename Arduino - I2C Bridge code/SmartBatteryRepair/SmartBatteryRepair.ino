/*
    * SmartBatteryRepair - A free tool to make it easy for end users to repair their Smart Batteries.
    * This is the code you need to upload to your Arduino (UNO or Mega), to make it work as a "bridge" for my software.
    * NOTE! You will need the SoftI2CMaster library for Arduino, https://github.com/felias-fogg/SoftI2CMaster
    *       That library is also available in the library manager, in the new Arduino IDE
    *
    * Do not change this code unless you know your Arduino coding, as you might stop the bridge from working.
    * 
    * Developed by @LetUsRepair / Geir O. Andersen https://github.com/LetUsRepair/SmartBatteryRepair/
*/
                ...
                case read_data: // 0x04 - read data
                {
                    switch (subdatacode) // evaluate SUB-DATA CODE byte
                    {
                        ...
                        case sd_read_chip_name:
                        {
                            ...
                            uint8_t block_length = read_block(0x21, buffer);
                            uint8_t response_length = block_length + 1;
                            uint8_t response[response_length];
                            response[0] = 0x21;
                            ...
                            send_usb_packet(read_data, sd_read_chip_name, response, response_length);
                            break;
                        }
...
/*
 * Original, by author below; His code is on his GitHub
